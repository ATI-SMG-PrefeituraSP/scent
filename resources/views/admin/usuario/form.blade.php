    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.usuario.salvar')}}"  class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input required type="text" name="name" value="{{ isset($registro)? $registro->name : old('name') }}" class="form-control  <?php if($errors->has('name')) echo "is-invalid" ?>">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input required type="text" name="username" value="{{ isset($registro)? $registro->username : old('username') }}" class="form-control  <?php if($errors->has('username')) echo "is-invalid" ?>">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input required type="email" name="email" value="{{ isset($registro)? $registro->email : old('email') }}" class="form-control   <?php if($errors->has('email')) echo "is-invalid" ?>">
                            @if ($errors->has('email'))
                                <span class="text-danger">
                                {{ $errors->first('email') }}
                                </span>
